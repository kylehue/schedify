import{d as N,r as $,j as f,L as T,M as z,t as A,h as s,l as d,c3 as q,m as y,c4 as j,q as g,s as X,a3 as L,c5 as U,a_ as _,ak as G,af as P,g as K,C as O,bO as J,aV as Q,E as ee,F as ae,G as te,bV as ne,ah as oe,U as le,c6 as ie,z as w,aR as re,c7 as se,o as u,c as m,aq as C,ar as Y,a2 as I,a as h,az as ue,as as de,at as fe,w as B,b as ce,u as R,c8 as me,c9 as he}from"./BfFSrwMz.js";import{g as pe}from"./xT7y-dx9.js";const E=N({name:"SlotMachineNumber",props:{clsPrefix:{type:String,required:!0},value:{type:[Number,String],required:!0},oldOriginalNumber:{type:Number,default:void 0},newOriginalNumber:{type:Number,default:void 0}},setup(e){const a=$(null),n=$(e.value),i=$(e.value),t=$("up"),o=$(!1),r=f(()=>o.value?`${e.clsPrefix}-base-slot-machine-current-number--${t.value}-scroll`:null),p=f(()=>o.value?`${e.clsPrefix}-base-slot-machine-old-number--${t.value}-scroll`:null);T(A(e,"value"),(l,c)=>{n.value=c,i.value=l,z(H)});function H(){const l=e.newOriginalNumber,c=e.oldOriginalNumber;c===void 0||l===void 0||(l>c?v("up"):c>l&&v("down"))}function v(l){t.value=l,o.value=!1,z(()=>{var c;(c=a.value)===null||c===void 0||c.offsetWidth,o.value=!0})}return()=>{const{clsPrefix:l}=e;return s("span",{ref:a,class:`${l}-base-slot-machine-number`},n.value!==null?s("span",{class:[`${l}-base-slot-machine-old-number ${l}-base-slot-machine-old-number--top`,p.value]},n.value):null,s("span",{class:[`${l}-base-slot-machine-current-number`,r.value]},s("span",{ref:"numberWrapper",class:[`${l}-base-slot-machine-current-number__inner`,typeof e.value!="number"&&`${l}-base-slot-machine-current-number__inner--not-number`]},i.value)),n.value!==null?s("span",{class:[`${l}-base-slot-machine-old-number ${l}-base-slot-machine-old-number--bottom`,p.value]},n.value):null)}}}),{cubicBezierEaseOut:Z}=q;function ve({duration:e=".2s"}={}){return[d("&.fade-up-width-expand-transition-leave-active",{transition:`
 opacity ${e} ${Z},
 max-width ${e} ${Z},
 transform ${e} ${Z}
