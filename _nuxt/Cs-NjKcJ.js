import{d as N,r as $,m as d,I as R,T as B,L as A,h as s,z as u,aj as D,x as y,ak as F,y as g,A as _,al as j,am as q,Z as X,an as L,ao as z,D as U,E as P,ap as G,J as K,aq as J,U as Q,O as ee,ar as ae,as as te,at as ne,au as re,l as x,t as le,av as oe,o as f,c as m,aw as E,ai as O,p as T,a as h}from"./BLlqf3sr.js";import{g as ie}from"./ULfbgNna.js";const C=N({name:"SlotMachineNumber",props:{clsPrefix:{type:String,required:!0},value:{type:[Number,String],required:!0},oldOriginalNumber:{type:Number,default:void 0},newOriginalNumber:{type:Number,default:void 0}},setup(e){const a=$(null),l=$(e.value),i=$(e.value),n=$("up"),t=$(!1),o=d(()=>t.value?`${e.clsPrefix}-base-slot-machine-current-number--${n.value}-scroll`:null),p=d(()=>t.value?`${e.clsPrefix}-base-slot-machine-old-number--${n.value}-scroll`:null);R(A(e,"value"),(r,c)=>{l.value=c,i.value=r,B(H)});function H(){const r=e.newOriginalNumber,c=e.oldOriginalNumber;c===void 0||r===void 0||(r>c?v("up"):c>r&&v("down"))}function v(r){n.value=r,t.value=!1,B(()=>{var c;(c=a.value)===null||c===void 0||c.offsetWidth,t.value=!0})}return()=>{const{clsPrefix:r}=e;return s("span",{ref:a,class:`${r}-base-slot-machine-number`},l.value!==null?s("span",{class:[`${r}-base-slot-machine-old-number ${r}-base-slot-machine-old-number--top`,p.value]},l.value):null,s("span",{class:[`${r}-base-slot-machine-current-number`,o.value]},s("span",{ref:"numberWrapper",class:[`${r}-base-slot-machine-current-number__inner`,typeof e.value!="number"&&`${r}-base-slot-machine-current-number__inner--not-number`]},i.value)),l.value!==null?s("span",{class:[`${r}-base-slot-machine-old-number ${r}-base-slot-machine-old-number--bottom`,p.value]},l.value):null)}}}),{cubicBezierEaseOut:M}=D;function se({duration:e=".2s"}={}){return[u("&.fade-up-width-expand-transition-leave-active",{transition:`
 opacity ${e} ${M},
 max-width ${e} ${M},
 transform ${e} ${M}
 ...
 width: .6em;
 max-width: .6em;
 `,[se({duration:".2s"}),F({duration:".2s",delay:"0s"}),y("base-slot-machine-old-number",`
 display: inline-block;
 opacity: 0;
 position: absolute;
 left: 0;
 ...
 transform: translateY(0);
 width: .6em;
 `,[g("down-scroll",{animation:"n-base-slot-machine-fade-down-in .2s cubic-bezier(0, 0, .2, 1)",animationIterationCount:1}),g("up-scroll",{animation:"n-base-slot-machine-fade-up-in .2s cubic-bezier(0, 0, .2, 1)",animationIterationCount:1}),_("inner",`
 display: inline-block;
 position: absolute;
 right: 0;
 top: 0;
 ...
 right: unset;
 left: 0;
 `)])])])])]),de=N({name:"BaseSlotMachine",props:{clsPrefix:{type:String,required:!0},value:{type:[Number,String],default:0},max:{type:Number,default:void 0},appeared:{type:Boolean,required:!0}},setup(e){j("-base-slot-machine",ue,A(e,"clsPrefix"));const a=$(),l=$(),i=d(()=>{if(typeof e.value=="string")return[];if(e.value<1)return[0];const n=[];let t=e.value;for(e.max!==void 0&&(t=Math.min(e.max,t));t>=1;)n.push(t%10),t/=10,t=Math.floor(t);return n.reverse(),n});return R(A(e,"value"),(n,t)=>{typeof n=="string"?(l.value=void 0,a.value=void 0):typeof t=="string"?(l.value=n,a.value=void 0):(l.value=n,a.value=t)}),()=>{const{value:n,clsPrefix:t}=e;return typeof n=="number"?s("span",{class:`${t}-base-slot-machine`},s(X,{name:"fade-up-width-expand-transition",tag:"span"},{default:()=>i.value.map((o,p)=>s(C,{clsPrefix:t,key:i.value.length-p-1,oldOriginalNumber:a.value,newOriginalNumber:l.value,value:o}))}),s(q,{key:"+",width:!0},{default:()=>e.max!==void 0&&e.max<n?s(C,{clsPrefix:t,value:"+"}):null})):s("span",{class:`${t}-base-slot-machine`},n)}}});function ce(e){const{errorColor:a,infoColor:l,successColor:i,warningColor:n,fontFamily:t}=e;return{color:a,colorInfo:l,colorSuccess:i,colorError:a,colorWarning:n,fontSize:"12px",fontFamily:t}}const fe={name:"Badge",common:L,self:ce},me=u([u("@keyframes badge-wave-spread",{from:{boxShadow:"0 0 0.5px 0px var(--n-ripple-color)",opacity:.6},to:{boxShadow:"0 0 0.5px 4.5px var(--n-ripple-color)",opacity:0}}),y("badge",`
 display: inline-flex;
 position: relative;
 vertical-align: middle;
 font-family: var(--n-font-family);
 `,[g("as-is",[y("badge-sup",{position:"static",transform:"translateX(0)"},[z({transformOrigin:"left bottom",originalTransform:"translateX(0)"})])]),g("dot",[y("badge-sup",`
 height: 8px;
 width: 8px;
 padding: 0;
 min-width: 8px;
 ...
 display: flex;
 align-items: center;
 `,[z({transformOrigin:"left bottom",originalTransform:"translateX(-50%)"}),y("base-wave",{zIndex:1,animationDuration:"2s",animationIterationCount:"infinite",animationDelay:"1s",animationTimingFunction:"var(--n-ripple-bezier)",animationName:"badge-wave-spread"}),u("&::before",`
 opacity: 0;
 transform: scale(1);
 border-radius: 9px;
 content: "";
